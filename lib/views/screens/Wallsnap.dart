...
class WallSnap extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Consumer<ConnectivityController>(
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                            "${data['imageHeight']} X ${data['imageWidth']}".toUpperCase(),
                                                                            style:
                                                                                TextStyle(
                                                                              color: Colors.black87,
                                                                              fontFamily: 'Medium',
